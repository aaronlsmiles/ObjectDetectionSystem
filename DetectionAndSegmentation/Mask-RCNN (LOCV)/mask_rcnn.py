...
parser = argparse.ArgumentParser(description='Use this script to run Mask-RCNN (LOCV) object detection and segmentation')
...
winName = 'Mask-RCNN (LOCV) Object detection and Segmentation in OpenCV'
...
while cv.waitKey(1) < 0:
    ...
    label = 'Mask-RCNN (LOCV) on 2.5 GHz Intel Core i7 CPU, Inference time for a frame : %0.0f ms' % abs(t * 1000.0 / cv.getTickFrequency())
