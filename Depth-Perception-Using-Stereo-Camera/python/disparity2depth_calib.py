...
assert os.path.exists("../data/X/depth_estimation_params_py.xml"), os.getcwd()
...
cv_file = cv2.FileStorage("../data/X/depth_estimation_params_py.xml", cv2.FILE_STORAGE_READ)
...
cv_file = cv2.FileStorage("../data/X/depth_estimation_params_updated_py.xml", cv2.FILE_STORAGE_WRITE)
