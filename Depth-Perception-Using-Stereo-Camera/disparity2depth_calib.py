...
CamL_id = 3 # Camera ID for left camera
...
cv_file = cv2.FileStorage("../X/data/stereo_rectify_maps.xml", cv2.FILE_STORAGE_READ)
...
cv_file = cv2.FileStorage("../data/X/depth_estmation_params_py.xml", cv2.FILE_STORAGE_READ)
...
cv_file = cv2.FileStorage("../data/X/depth_estmation_params_py.xml", cv2.FILE_STORAGE_WRITE)
